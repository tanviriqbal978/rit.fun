...
const HomeView = ({ 
  tokens, loading, error, fetchTokens, setCurrentPage, setSelectedToken, uiError, setUiError 
}: any) => (
...
const DetailView = ({ 
  selectedToken, trades, trade, account, setCurrentPage, uiError, setUiError 
}: any) => (
  <div style={{ padding: '20px' }}>
...
const LaunchView = ({
  account, connectWallet, launchToken, setCurrentPage, uiError, setUiError
}: any) => {
...
const PortfolioView = ({ account, connectWallet, tokens, setCurrentPage, setSelectedToken }: any) => (
  <div style={{ padding: '20px' }}>
    ...
    {!account ? (
      <div style={{ padding: '40px', textAlign: 'center', backgroundColor: COLORS.cardBackground, border: `1px solid ${COLORS.border}` }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
            {tokens.filter((t: any) => t.creator === account).map((token: any) => (
  ...
  return (
    <div style={{ 
      ...
      <main style={{ flex: 1 }}>
        ...
        {currentPage === 'detail' && selectedToken && (
          <DetailView 
